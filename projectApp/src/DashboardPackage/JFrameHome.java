...
import LoginPackage.JFrameLogin.UserSession;
...
//        labelUser = new JLabel(); // Initialize labelUser
//        labelLevel = new JLabel(); // Initialize labelLevel
//        labelUser.setText("Username: " + UserSession.getUsername());
//        labelLevel.setText("UserLevel: " + UserSession.getUserLevel());

    }
    private void initComponents(UserSession loggedInUser) {
             labelUser.setText("Welcome " + UserSession.getUsername()+ " | Level: " + UserSession.getUserLevel()); 
    }
    ...
    private void initComponents() {
        ...
        labelUser.setText("ss");
        PanelMenu1.add(labelUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 160, 20));

        labelLevel.setText("ss");
        PanelMenu1.add(labelLevel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 150, 30));
        ...
        labelSetting.setFont(new java.awt.Font("Segoe UI", 1, 17)); // NOI18N
        labelSetting.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Asset/settingIcon.png"))); // NOI18N
        labelSetting.setText("Setting");
        labelSetting.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        labelSetting.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                labelSettingMouseClicked(evt);
            }
        });
        PanelMenu.add(labelSetting, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 480, -1, -1));
        ...
        PanelMenu.add(labelLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 530, -1, -1));
        ...
        PanelMenu.add(panelLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 200, 40));

        panelSetting.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        PanelMenu.add(panelSetting, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 200, 40));
        panelSetting.getAccessibleContext().setAccessibleName("");
        ...
        Attendance.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, 640, 250));
        ...
        rSMaterialButtonRectangle2.setText("Download");
        Recapitulation.add(rSMaterialButtonRectangle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 570, 120, 40));
